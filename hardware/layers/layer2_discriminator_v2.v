...
`ifndef LAYER2_DISCRIMINATOR_V2_V
`define LAYER2_DISCRIMINATOR_V2_V

// Layer 2 Discriminator (v2 - New Architecture)
...
//
module layer2_discriminator_v2 (
    input wire clk,
    input wire rst,
    input wire start,
    ...
    always @(posedge clk) begin
        if (rst) begin
            ...
            if (start && !busy) begin
                ...
                accumulator <= { {10{biases[0][15]}}, biases[0], 10'b0 };
                ...
                if (input_idx < TOTAL_INPUTS) begin
                    ...
                    if (neuron_idx < TOTAL_NEURONS - 1) begin
                        ...
                        accumulator <= { {10{biases[neuron_idx + 9'd1][15]}}, biases[neuron_idx + 9'd1], 10'b0 };
                    end else begin
...
`endif // LAYER2_DISCRIMINATOR_V2_V
